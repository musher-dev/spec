...
* **component:** a node this platform does not run — ADR 0019, on ADR 0007 and ADR 0009 ([#80](https://github.com/musher-dev/spec/issues/80)) ([e69f1ed](https://github.com/musher-dev/spec/commit/e69f1edcf862c3dd503d8e94c45ec8706f020b31))
* **component:** let the install form say what control it asks for ([#79](https://github.com/musher-dev/spec/issues/79)) ([7b79284](https://github.com/musher-dev/spec/commit/7b79284156b6cd6514e8391ed2ba2c524438b0c3))
* **component:** several values from a named set — STRING_LIST, ADR 0020 ([#85](https://github.com/musher-dev/spec/issues/85)) ([f27e2a9](https://github.com/musher-dev/spec/commit/f27e2a977c53e73f5ef8f6f01ade3167e3476fdc))
...
* **repo:** publish a generated field reference at schemas.musher.dev/reference ([#77](https://github.com/musher-dev/spec/issues/77)) ([8ff7c2a](https://github.com/musher-dev/spec/commit/8ff7c2ae7ed41b9404fb7975206dd60199e24ac7))
